...
const PythonIcon: FunctionComponent<Props> = ({ width = '80', height = '80', ...rest }) => (
  <svg width={width} height={height} preserveAspectRatio="xMidYMid meet" viewBox="0 0 256 255" {...rest}>
    <defs>
      <linearGradient x1="12.959%" y1="12.039%" x2="79.639%" y2="78.201%" id="ssvg-id-pythona">
        <stop stopColor="#387EB8" offset="0%" />
        <stop stopColor="#366994" offset="100%" />
      </linearGradient>
      <linearGradient x1="19.128%" y1="20.579%" x2="90.742%" y2="88.429%" id="ssvg-id-pythonb">
